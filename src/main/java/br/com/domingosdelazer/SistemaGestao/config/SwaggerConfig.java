...
public class SwaggerConfig {
    ...
    public Docket docket(){
        return new Docket(DocumentationType.OAS_30)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.domingosdelazer.SistemaGestao.rest.controller"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                .title("Sistema de Gestão - Domingo de Lazer")
                .description("Sistema de Gestão designado para os Domingos de Lazer")
                .version("1.0.0")
