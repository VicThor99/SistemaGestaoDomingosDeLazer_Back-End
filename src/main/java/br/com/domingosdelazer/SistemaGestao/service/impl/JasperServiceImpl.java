        ...
        for (Integer sala : alunosPorSala.keySet()) {
            ...
            for (int i = 0; i < alunosDaSala.size(); i++) {
                ...
                alunosJSON.append("\"DOMINGO\":\"DOM-")
                        .append(alunosDaSala.get(0).getSerie().getDomingo())
                        .append("\",");
                ...
                alunosJSON.append("\"TOTAL_ALUNOS\":\"")
                        .append(alunosDaSala.size())
                        .append(" ALUNOS\",");

                alunosJSON.append("\"CODIGO_1\":\"")
                        .append(alunosDaSala.get(i + contador).getCodigo())
                        .append("\",");
                alunosJSON.append("\"NOME_1\":\"")
                        .append(alunosDaSala.get(i + contador).getNome())
                        .append("\",");
                alunosJSON.append("\"SEXO_1\":\"")
                        .append(alunosDaSala.get(i + contador).getSexo())
                        .append("\",");
                alunosJSON.append("\"NASCIMENTO_1\": \"")
                        .append(alunosDaSala.get(i + contador).getNascimento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")))
                        .append("\",");
                alunosJSON.append("\"TENIS_1\":\"")
                        .append(alunosDaSala.get(i + contador).getSapato() == null ? "" : alunosDaSala.get(i + contador).getSapato())
                        .append("\",");
                alunosJSON.append("\"BLUSA_1\":\"")
                        .append(alunosDaSala.get(i + contador).getCamisa() == null ? "" : alunosDaSala.get(i + contador).getCamisa())
                        .append("\",");
                alunosJSON.append("\"CALCA_1\":\"")
                        .append(alunosDaSala.get(i + contador).getCalca() == null ? "" : alunosDaSala.get(i + contador).getCalca())
                        .append("\",");
                alunosJSON.append("\"FEV_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getFevereiro().getSigla())
                        .append("\",");
                alunosJSON.append("\"MAR_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getMarco().getSigla())
                        .append("\",");
                alunosJSON.append("\"ABR_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getAbril().getSigla())
                        .append("\",");
                alunosJSON.append("\"MAI_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getMaio().getSigla())
                        .append("\",");
                alunosJSON.append("\"JUN_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getJunho().getSigla())
                        .append("\",");
                alunosJSON.append("\"AGO_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getAgosto().getSigla())
                        .append("\",");
                alunosJSON.append("\"SET_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getSetembro().getSigla())
                        .append("\",");
                alunosJSON.append("\"OUT_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getOutubro().getSigla())
                        .append("\",");
                alunosJSON.append("\"NOV_1\":\"")
                        .append(alunosDaSala.get(i + contador).getRegistroPresencas().getNovembro().getSigla())
                        .append("\",");
                alunosJSON.append("\"SAIR_SO_1\":\"")
                        .append(alunosDaSala.get(i + contador).getSairSozinho() ? "SIM" : "NÃO")
                        .append("\",");
                alunosJSON.append("\"MATRICULADO_1\":\"")
                        .append(alunosDaSala.get(i + contador).getAtivo() ? "SIM" : "NÃO")
                        .append("\",");

                contador++;

                if ((i + 1) < alunosDaSala.size()) {
