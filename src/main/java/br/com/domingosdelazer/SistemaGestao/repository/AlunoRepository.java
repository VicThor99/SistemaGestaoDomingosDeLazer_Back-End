...
public interface AlunoRepository extends JpaRepository<Aluno, Integer> {
    ...
    @Query(nativeQuery = true, value = "select a.* from domingosdelazer.aluno a " +
            "inner join domingosdelazer.registropresencas r on r.id = a.registro_id " +
    ...
    @Query(nativeQuery = true, value = "select count(*) from domingosdelazer.aluno a " +
            "inner join domingosdelazer.registropresencas r on r.id = a.registro_id " +
            "inner join domingosdelazer.serie s on s.id = a.serie_id " +
            "WHERE (LENGTH(CONCAT(r.marco, r.abril, r.maio, r.junho, r.agosto, r.setembro, r.outubro, r.novembro)) " +
            "- LENGTH(REPLACE(CONCAT(r.marco, r.abril, r.maio, r.junho, r.agosto, r.setembro, r.outubro, r.novembro), '5', ''))) < 3 " +
    ...
    @Query(nativeQuery = true, value = "select a.codigo from domingosdelazer.aluno a " +
            "inner join domingosdelazer.serie s on s.id = a.serie_id " +
    ...
    @Query(nativeQuery = true, value = "select * from domingosdelazer.aluno a " +
            "inner join domingosdelazer.registropresencas r on r.id = a.registro_id " +
            "inner join domingosdelazer.serie s on s.id = a.serie_id " +
            "WHERE (LENGTH(CONCAT(r.marco, r.abril, r.maio, r.junho, r.agosto, r.setembro, r.outubro, r.novembro)) " +
    ...
    @Query(nativeQuery = true, value = "select * from domingosdelazer.aluno a WHERE a.codigo = :codigo AND a.escola_id = :escolaId")
    ...
    @Query(nativeQuery = true, value = "select * from domingosdelazer.aluno a WHERE a.ativo = true AND a.escola_id = :escolaId")
    List<Aluno> getAlunosAtivos(@Param("escolaId") Integer escolaId);

    @Query(nativeQuery = true, value = "select * from domingosdelazer.aluno a WHERE a.escola_id = :escolaId")
